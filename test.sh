...
assert 7 'main() { int a; int b; int c; int d; a=7;b=a;c=b; return d=c; }'
assert 64 'main() { int a; int z; a=60;z=4; return a+z; }'
assert 9 'main() { int foo; return foo=9; }'
assert 15 'main() { int foo; int bar; foo=20;bar=5; return foo-bar; }'
assert 12 'main() { int a_1; int a_2; int a_3; int a_4; a_1 = 2; a_2 = 2; a_3 = 3; a_4 = a_1 * a_2 * a_3; return a_4; }'
assert 1 'main() { int a; int b; int c; int d; int e; int f; int g; a = b = c = d = e = f = g = 1; return a; }'
assert 4 'main() { int a; int b; int c; int d; a = (b = (c = (d = 1) + 1) + 1) + 1; if (d == 1) return a; else return 100;}'
assert 1 'main() { int a; int b; return a = (b = 1); }'
...
assert 1 'main() { int a; a = 1; if (a) return 1; return 2; }'
assert 2 'main() { int a; a = 0; if (a) return 1; return 2; }'
assert 1 'main() { int a; int b; a = 0; b = 1; if (a + b) return 1; return 2; }'
assert 2 'main() { int a; int b; a = 0; b = 0; if (a + b) return 1; return 2; }'
...
assert 5 'main() { int a; a=10; while (a > 5) a = a - 1; return a; }'
assert 55 'main() { int i; int j; i = 0; j = 0; for (i = 0; i <= 10; i = i + 1) j = i + j; return j; }'
assert 55 'main() { int i; int j; i = 0; j = 0; for (; i <= 10; i = i + 1) j = i + j; return j; }'
assert 11 'main() { int i; i = 0; for (; i <= 10;) i = i + 1; return i; }'
...
assert 10 'main() { ;; int a; a = 10;; ; ; return arg1(a); }'

assert 0 'main() { hello(); }'
assert 19 'main() { return arg0(); }'
assert 20 'main() { return arg0() + 1; }'
assert 10 'main() { int a; a = arg0(); return 10; }'
...
assert 20 'main() { int i; i = 10; { int i; i = 20; return i; } return 30; }'
assert 4 'main() { int a; a = 4; { int a; a = 15; put_num(a); } { put_num(a); } return a; }'

assert 13 'foo(x,y) { int z; z = 10; return x + y + z; } main() { int x; int y; x = 1; y = 2; return foo(x, y); }'
assert 0 '
fib(x) {
  if (x == 0) {
    return 0;
...
assert 3 'main() { int x; int y; int z; x = 3; y = 5; z = &y + 8; put_num(&x); put_num(z); return *z; }'
assert 3 'main() { int x; int y; x = 3; y = 5; return *(&y + 8); }'
assert 5 'main() { int x; int y; int z; x = 3; y = 5; z = 7; return *(&y); }'
assert 2 'main() { int x; int y; y = &x; put_num(&x); put_num(y); *y = 2; return x;}'
assert 2 'main() { int x; int y; int z; y = &x; z = &y; **z = 2; return x;}'
